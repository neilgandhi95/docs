...
**For example,** if I'm selling Send, rather than just following up on a proposal, I can create prospects a **live Send account** with their own branded example using their company name and industry-specific content.
