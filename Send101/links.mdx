...
![Custom Links Send Pn](/images/CustomLinks-Send.png)

**<u>Real use cases for custom link tracking:</u>**

- **Sales Outreach**: Create `send.co/demo-acme-corp-U8Ny6KWh` to track when Acme Corp views your product demo and follow up at the perfect moment.
- **Marketing Campaigns**: Use `send.co/linkedin-campaign-U8Ny6KWh` vs `send.co/email-newsletter-U8Ny6KWh` to see which channel drives more engagement with your content.
- **Investor Relations**: Share `send.co/pitch-deck-series-a-U8Ny6KWh` with VCs to identify which investors are actively reviewing your funding materials.
...
> Track individual viewer engagement, perfect for commercial outreach and VC presentations

![Custom Link - Example Person.png](/images/CustomLink-ExamplePerson.png)

**By Campaign**:

> Track which campaign is generating more views and engaement.

![Custom Link - Example Campaign.png](/images/CustomLink-ExampleCampaign.png)

**By Channel**:

> Compare channel performance to optimize your distribution strategy.
